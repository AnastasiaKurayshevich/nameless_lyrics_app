...
//    }
    ...
    public void testIfWeCanCreateNewLyric() {
        ...
        songSong.setSongName("SongLyric yoyoyo");
        ...
        assertEquals("SongLyric yoyoyo", retrievedSong.getSongName());
        assertEquals(2, retrievedSong.getSongList().size());
        assertEquals("verse1", retrievedSong.getSongList().get(0).getLyricTitle());
        assertEquals("test lyric2", retrievedSong.getSongList().get(1).getLyric());
